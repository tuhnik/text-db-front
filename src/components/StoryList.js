...
class StoryList extends Component {
  ...
  render() {
    return (<>
        {data.map((el, i)=>{
            return <StoryItem key={i} id={el.id} heading={el.heading} tags={el.tags} description={this.desc(el)} date={el.date} views={el.views}/>
        })}
        </>
    );
  }
